...
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/math_symbo.jpg)
<strong>&nbsp;&nbsp;&nbsp;&nbsp;B. 比较运算：</strong>
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/compare_symbo.jpg)
<strong>&nbsp;&nbsp;&nbsp;&nbsp;C. 赋值运算：</strong>
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/assign_symbo.jpg)
<strong>&nbsp;&nbsp;&nbsp;&nbsp;D. 逻辑运算：</strong>
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/logic_symbo.jpg)
<strong>&nbsp;&nbsp;&nbsp;&nbsp;E. 成员运算：</strong>
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/member_symbo.jpg)
<strong>&nbsp;&nbsp;&nbsp;&nbsp;F. 身份运算：</strong>
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/id_symbo.jpg)
<strong>&nbsp;&nbsp;&nbsp;&nbsp;G. 位运算：</strong>
![math_symbo.png]({{ site.BASE_PATH }}/assets/images/bit_symbo.jpg)
